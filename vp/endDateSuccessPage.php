...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container glassmorphic text-center">
            ...
            <div class="shadow">
                <h3 class="text-dark">Hey Champ! Good Job.Your vaping duration lasted <?php echo $_SESSION['duration']; ?> days . Try to make the next duration <?php echo $_SESSION['newDuration']; ?> </h3>
                <!-- "Good Job.Your vaping duration lasted " . $duration . " days . Try to make the next duration " . $newDuration . ". " -->
            </div>
        </div>
